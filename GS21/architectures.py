...
GraphRecurrentNN: implements the GRNN architecture with a single-layer hidden
    state and a single-layer output.
GatedGraphRecurrentNN: implements the (time, node, edge)-gated GRNN architecture
"""
